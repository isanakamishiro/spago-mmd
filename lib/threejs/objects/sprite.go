...
func NewSprite(material materials.SpriteMaterial) Sprite {
	return &spriteImpl{
		threejs.NewObject3DFromJSValue(
			threejs.GetJsObject("Sprite").New(material.JSValue()),
		),
	}
}
...
func (c *spriteImpl) Material() threejs.Material {
	return materials.NewSpriteMaterialFromJSValue(
...
func (c *spriteImpl) Geometry() threejs.BufferGeometry {
	return threejs.NewDefaultBufferGeometryFromJSValue(
