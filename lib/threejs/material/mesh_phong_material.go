...
func NewMeshPhongMaterial(parameters MeshPhongMaterialParameters) MeshPhongMaterial {
	return &meshPhongMaterialImp{
		threejs.NewDefaultMaterialFromJSValue(threejs.Threejs("MeshPhongMaterial").New(parameters)),
	}
