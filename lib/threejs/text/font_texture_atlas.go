...
type FontTextureMetrics struct {
	...
	CanvasTexture texture.CanvasTexture
...
func (c *FontTextureAtlas) createDefaultCanvasTexture() texture.CanvasTexture {

	cv := texture.NewCanvas()
	...
	cvTexture := texture.NewCanvasTexture(cv)
